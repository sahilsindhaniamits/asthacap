...
<div class="main">
    <div>
        ...
        <div id="recharge" class="tabcontent" style="display: block;">
            <div>
                <table class="table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        @foreach($recharges as $index => $transaction)
                        <tr>
        ...
        <div id="withdrawl" class="tabcontent" style="display: none;">
            <div>
                <table class="table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        @foreach($withdrawl as $index => $transaction)
                        <tr>
                            <th scope="row">{{ $index + 1 }}</th>
                            <td>{{ $transaction->amount }}</td>
                            <td>
    ...
    <div class="invitationLinkContainer">
        <div class="invitationLink">
            ...
            <b>
                {{ url('/') }}/register?code={{ auth()->user()->referral_code }}
            </b>
        </div>
