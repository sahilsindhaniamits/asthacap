...
/* Top bar */
.top-bar { height: 4px; background: linear-gradient(90deg, #6366f1, #06b6d4, #8b5cf6, #6366f1); flex-shrink: 0; }

/* Header - NO black border, only gradient line */
.header { padding: 14px 36px 10px; display: flex; align-items: center; justify-content: space-between; flex-shrink: 0; position: relative; border-bottom: none; }
.header::after { content: ''; position: absolute; bottom: 0; left: 36px; right: 36px; height: 2px; background: linear-gradient(90deg, #6366f1, #06b6d4, #8b5cf6); border-radius: 2px; }
.logo-area { display: flex; align-items: center; gap: 10px; }
.logo-area img { height: 42px; }
.company-info h1 { font-size: 16px; color: #1e1b4b; font-weight: 800; letter-spacing: 0.3px; }
.company-info .tagline { font-size: 8px; color: #6366f1; font-style: italic; margin-top: 1px; }
.company-info .reg-info { font-size: 7px; color: #666; margin-top: 2px; letter-spacing: 0.3px; }
.header-right { text-align: right; }
.header-right .ref-no { font-size: 9px; color: #1e1b4b; font-weight: 700; background: #f0f0ff; padding: 2px 8px; border-radius: 3px; border: 1px solid #e0e0f0; display: inline-block; margin-bottom: 3px; }
.header-right .meta { font-size: 7.5px; color: #666; }
.header-right .meta span { display: block; margin: 1px 0; }

/* Content */
.content { padding: 10px 36px 8px; position: relative; z-index: 1; flex: 1; display: flex; flex-direction: column; }

/* Document Title */
.doc-title { text-align: center; margin: 6px 0 8px; }
.doc-title h2 { font-size: 13px; color: #fff; display: inline-block; padding: 5px 26px; background: linear-gradient(135deg, #1e1b4b, #312e81); border-radius: 3px; letter-spacing: 1.5px; text-transform: uppercase; }
.doc-title .doc-id { font-size: 7px; color: #888; margin-top: 3px; letter-spacing: 0.5px; }
...
.loan-amount { font-size: 14px !important; font-weight: 800 !important; color: #1e1b4b !important; }
...
.auth-sig-block p { font-size: 8px; font-weight: 700; color: #1e1b4b; }
...
.footer-main { display: flex; justify-content: space-between; align-items: center; padding: 6px 36px; background: #f8fafc; border-top: 1px solid #e5e7eb; }
.footer-left { font-size: 7.5px; color: #666; }
.footer-left span { display: block; margin: 1px 0; }
.footer-center { text-align: center; }
.footer-center span { font-size: 7px; color: #888; display: block; }
.footer-right { text-align: right; font-size: 7.5px; color: #666; }
.footer-right span { display: block; margin: 1px 0; }
.footer-bar { height: 3px; background: linear-gradient(90deg, #6366f1, #06b6d4, #8b5cf6, #6366f1); }
.footer-bottom { text-align: center; background: #1e1b4b; padding: 4px; }
.footer-bottom a { color: #a5b4fc; font-size: 8.5px; font-weight: 600; text-decoration: none; letter-spacing: 0.5px; }
.footer-bottom .disclaimer { font-size: 6.5px; color: #6b7280; margin-top: 1px; }
</style>
</head>
<body>
...
<div class="content">
    ...
    <div class="detail-box loan-box">
        ...
        <table>
            <tr><td>Sanctioned Loan Amount</td><td class="loan-amount">&#8377; {{ number_format($obj->sanctioned_amount) }}/-</td></tr>
    ...
    <div class="system-note">
        This is a system-generated document. | Doc Ref: ACF-SL-{{ date('Ymd') }}-{{ str_pad($obj->id, 5, '0', STR_PAD_LEFT) }} | For queries: +91 9649596982 | support@aasthacapitalfinance.com
    </div>
