         ...
         <div class="container-fluid  py-5" style="margin-bottom: 90px;background-color : black">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Business Loan</h1>
                    <a href="/home" class="h5 text-white">Home</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Business Loan</a>
                </div>
            </div>
        </div>
        <!-- About Start -->
            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    <div class="section-title position-relative pb-3 mb-5">
                        <h1 class="mb-0">Business Loan</h1>
                    </div>
                    <p class="mb-4">Business Loan With Shri Saraswati Finance business loans, funding for your small business is now easy and hassle-free. These varying types of business loans can give your business the boost it needs to reach newer heights with enhanced competitiveness and profitability.</p>
                ...
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.9s" src="{{ asset('/images/business.jpg') }}" style="object-fit: cover;">
                    </div>
                </div>
            </div>
        </div>
