...
<div class="col-md-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            ...
            <form class="forms-sample" action="{{ route('admin.banner.update', $banner->id) }}" method="POST">
                @method('PUT')
                @csrf
                <div class="row">
                    <div class="col-md-5 ">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="Name"  value="{{ $banner->name }}">
                        </div>
                    </div>
                    <div class="col-md-7 ">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-12 ">
                        <label>Image</label>
                        <input type="hidden" class="image" name="image"  value="{{ $banner->image }}">
                        <div>
                            <img src="{{ $banner->image }}" alt="" height="150px">
                        </div>
                ...
                <div class="form-check form-check-flat form-check-primary">
                    <label class="form-check-label">
                        <input type="checkbox" class="form-check-input" name="status" {{ $banner->status ? 'checked':'' }}">
                        Active
