       ...
       <div class="container-fluid  py-5" style="margin-bottom: 90px;background-color : black">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Construction Loan</h1>
                    <a href="/home" class="h5 text-white">Home</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Construction Loan</a>
                </div>
            </div>
        </div>
            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    <div class="section-title position-relative pb-3 mb-5">
                        <h1 class="mb-0">Construction Loan</h1>
                    </div>
                    <p class="mb-4">Apply for a construction loan with Maha Lakshmi Finance Company today & get the fund to construct your home.</p>
                    ...
                    <div class="d-flex align-items-center mb-4 wow fadeIn" data-wow-delay="0.6s">
                        ...
                        <div class="ps-4">
                            ...
                            <h4 class="text-primary mb-0">+91 8107329168</h4>
                        </div>
                    </div>
                ...
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.9s" src="{{ asset('/images/construction.jpg') }}" style="object-fit: cover;">
                    </div>
                </div>
            </div>
        </div>
