         ...
         <div class="container-fluid  py-5" style="margin-bottom: 90px;background-color : black">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Education Loan</h1>
                    <a href="/home" class="h5 text-white">Home</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Education Loan</a>
                </div>
            </div>
        </div>
            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    <div class="section-title position-relative pb-3 mb-5">
                        <h1 class="mb-0">Education Loan</h1>
                    </div>
                    <p class="mb-4">We’re working hard to make sure we can help as many students as possible with education loans for their studies abroad. If you’re looking to pursue your MBA degree or a postgraduate degree in engineering, business, law, public policy, or health sciences, Be connect with Shri Saraswati Finance Company.</p>
                ...
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.4s" src="{{ asset('/images/education.jpg') }}" style="object-fit: cover;">
                    </div>
                </div>
            </div>
        </div>
